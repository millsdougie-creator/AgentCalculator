...
function initCalculator() {
  ...
  // Trigger browser print dialog to export as PDF
  if (exportPdfBtn) {
    exportPdfBtn.addEventListener('click', () => {
      // Use window.print() to allow users to save the current view as PDF
      window.print();
    });
  }

  // Share summary via WhatsApp using encoded URL
  if (whatsappBtn) {
    whatsappBtn.addEventListener('click', () => {
      // Helper to get text content of summary fields
      const getText = (id) => {
      ...
      lines.push('Net Commission before Office Split: ' + getText('netBeforeSplitTotal'));
      lines.push('Total Office Share: ' + getText('totalOfficeShareDisplay'));
      lines.push('Commission Payable to Office: ' + getText('commissionPayableOfficeDisplay'));
      lines.push('Total VAT Collected: ' + getText('totalVatCollectedDisplay'));
      lines.push('Total PAYE Payable: ' + getText('totalPayeDisplay'));
      lines.push('Total Net Commissions to Agents: ' + getText('totalNetToAgentsDisplay'));
